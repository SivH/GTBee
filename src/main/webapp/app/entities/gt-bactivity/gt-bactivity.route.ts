...
export class GTBactivityResolve implements Resolve<IGTBactivity> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<GTBactivity> {
